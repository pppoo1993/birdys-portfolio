    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ height: '32px', padding: '0 10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0, background: 'transparent' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#27272a', border: '1.5px solid #09090b', marginRight: '-4px', zIndex: 3 }} />
          <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#3f3f46', border: '1.5px solid #09090b', marginRight: '-4px', zIndex: 2 }} />
          <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: 'rgba(204,255,0,0.5)', border: '1.5px solid #09090b', zIndex: 1 }} />
        </div>
      </div>
      ...
      <div style={{ padding: '8px 10px 6px', display: 'flex', flexDirection: 'column', background: 'linear-gradient(180deg, #09090b 0%, #111114 100%)', flexShrink: 0 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '12px' }}>
          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
            <div style={{ width: '24px', height: '6px', background: 'rgba(204,255,0,0.25)', borderRadius: '2px' }} />
            <div style={{ width: '52px', height: '6px', background: '#27272a', borderRadius: '2px' }} />
          </div>
          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
            <div style={{ width: '32px', height: '6px', background: 'rgba(204,255,0,0.25)', borderRadius: '2px' }} />
          ...
          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
            <div style={{ width: '28px', height: '6px', background: 'rgba(204,255,0,0.25)', borderRadius: '2px' }} />
            <div style={{ width: '60px', height: '6px', background: '#27272a', borderRadius: '2px' }} />
          </div>
          <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
            <div style={{ width: '34px', height: '6px', background: '#27272a', borderRadius: '2px' }} />
            <div style={{ width: '44px', height: '6px', background: '#3f3f46', borderRadius: '2px' }} />
          </div>
        </div>
        <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
          ...
          <div style={{ width: '20px', height: '20px', background: '#ccff00', borderRadius: '50%', boxShadow: '0 0 8px rgba(204,255,0,0.2)' }} />
        </div>
      </div>
    </div>
  )
