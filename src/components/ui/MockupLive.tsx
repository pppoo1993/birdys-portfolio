export default function MockupLive() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#09090b' }}>
      <div style={{ height: '32px', padding: '0 10px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div style={{ flex: '0 0 40%', background: '#141416', position: 'relative', borderBottom: '1px solid #050506' }}>
                  </div>
        <div style={{ flex: '0 0 50%', background: '#18181b', display: 'flex' }}>
