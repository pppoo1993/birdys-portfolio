      ...
      <ScrollReveal>
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 items-center px-6 md:px-12">
          ...
          <div className="lg:col-span-5 flex items-center justify-center lg:justify-end">
            <div
              className="relative p-6 rounded-lg border border-[#1f1f23] flex flex-col items-center gap-0 transition-all duration-300 group hover:border-[#C7FF00]/30 bg-[#0a0a0c]/60"
              style={{
